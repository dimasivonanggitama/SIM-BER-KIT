...
class Kirim_surat extends Goodsyst_Controller
{
  public function __construct()
  {
      ...
      $this->load->model('ap_surat_sifat2_m');
  ...
  public function index($id=NULL){
    $this->data['pohon'] = $this->ap_surat_sifat_m->get();
          ...
          foreach ($this->data['pohon'] as $val) :
              array_push($this->data['parent_list'], $val->nama_sifat_kategori);
          endforeach
          ;
          ...
          $this->data['parent'] = $id;
           ...
           if ($id) {
			   ...
			   $this->data['sifat2'] = $this->ap_surat_sifat2_m->get();
               $this->data['jenis'] = $this->ap_surat_jenis_m->get();
               $this->data['status'] = $this->ap_surat_status_m->get();

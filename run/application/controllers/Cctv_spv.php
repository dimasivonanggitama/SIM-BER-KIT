...
class Cctv_spv extends Goodsyst_Controller
{
    ...
    public function unduh_pdf_cctv($id)
    {
        ...
        $datatbl=''; 
        $datatbl=$this->load->view('cctv_spv/view_download', $this->data, true);;
    ...
    public function unduh_pdf_cctv_old($id)
    {
        ...
        $datatbl=''; 
        $datatbl=$this->load->view('cctv_spv/view_download_old', $this->data, true);;

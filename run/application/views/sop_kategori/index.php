          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td><?php echo $no;?></td>
                  <td><?php echo $val->nama_sop_kategori;?></td>
                  <td>
                  <?php if ($val->parent_sop_kategori==0){echo $lang_parent;}else {echo $content_parent->nama_sop_kategori;}?>
                  </td>
                  <td align="center">
					<a href="<?php echo base_url($this->uri->rsegment(1).'/edit/'.$parent.'/'.$val->id_sop_kategori);?>" title="<?php echo $lang_edit;?>" class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i></a>
					<a onclick="return confirm('<?php echo $lang_are_you_sure;?>?');" href="<?php echo base_url($this->uri->rsegment(1).'/delete/'.$parent.'/'.$val->id_sop_kategori);?>" title="<?php echo $lang_delete;?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
				  </td>
                </tr>
                <?php
                $no++;

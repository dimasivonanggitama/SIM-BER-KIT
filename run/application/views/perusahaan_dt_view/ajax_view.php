...
Telepon Pemilik Perusahaan : <strong><?php echo $content->telp_pemilik_perusahaan?></strong> <br><br>
Email Pemilik Perusahaan : <strong><?php echo $content->email_pemilik_perusahaan?></strong><br>
SKEP Penetapan Perusahaan : <strong><?php echo $content->skep_penetapan_perusahaan?></strong><br><br>
...
Latitude Perusahaan : <strong><?php echo $content->latitude_perusahaan?></strong>

<div class="row">
        ...
        <div class="col-sm-8">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-4 control-label"><?php echo $lang_bulan_it;?></label>
				 <div class="col-sm-8">
                    <input type="text" name="bulan" class="form-control datepickerbulan" id="inputEmail3" placeholder="<?php echo $lang_bulan_it;?>" value="<?php echo $content->bulan_cctv?>" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-4 control-label"><?php echo $lang_tahun_it;?></label>
				 <div class="col-sm-8">
                    <input type="text" name="tahun" class="form-control datepickertahun" id="inputEmail3" placeholder="<?php echo $lang_tahun_it;?>" value="<?php echo $content->tahun_cctv?>" required>
                  </div>
                </div>
                <div class="form-group">
...
?>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-4 control-label"><?php echo $lang_hanggar_it;?></label>
				<div class="col-sm-8">
                    <input type="text" name=hanggar class="form-control" id="inputEmail3" placeholder="<?php echo $lang_hanggar_it;?>" value="<?php echo $content->hanggar_cctv?>" required>
                  </div>
                </div>

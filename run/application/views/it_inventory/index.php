        ...
        <div class="col-md-12">
		  <div class="box">
            ...
            <div class="box-body">
              ...
              <?php 
                $sql = "SELECT * FROM ap_it_cek WHERE id_cctv=?";
                $query = $this->db->query($sql,array($val->id_cctv));
                $row = $query->row();
                $sql1 = "SELECT COUNT(id_cctv) as total FROM ap_it_kegiatan WHERE id_cctv=?";
                  ...
                  <?php
                    ...
                    if (isset($ceker)){
                        if($val->flag_format_baru == 0 && $val->flag_pengajuan == 0){echo '-';}
                          elseif($val->flag_format_baru == 1 && $val->flag_pengajuan == 0 && $ceker->ya_tidak_cctv_cek == 0 && $ceker->ya_tidak_cctv_cek != NULL || $kegi->total >= 7 && $val->flag_format_baru == 1 && $val->flag_pengajuan == 0 && $ceker->ya_tidak_cctv_cek == 1 && $ceker->ya_tidak_cctv_cek != NULL || $val->flag_format_baru == 1 && $val->flag_pengajuan == 0 && $ceker->ya_tidak_cctv_cek == 2 && $ceker->ya_tidak_cctv_cek != NULL){
                          echo "<small class='label bg-yellow'>Silahkan Klik Ajukan</small>";
                         }elseif($kegi->total <= 6 && $val->flag_format_baru == 1 && $val->flag_pengajuan == 0 || $ceker->ya_tidak_cctv_cek == NULL){
              ...
              <td><div align="center" >
                <?php 
                  ...
                  <?php }elseif($val->flag_format_baru == 1 && $val->flag_pengajuan == 0 && $ceker->ya_tidak_cctv_cek == 0 && $ceker->ya_tidak_cctv_cek != NULL || $kegi->total >= 7 && $val->flag_format_baru == 1 && $val->flag_pengajuan == 0 && $ceker->ya_tidak_cctv_cek == 1 && $ceker->ya_tidak_cctv_cek != NULL || $val->flag_format_baru == 1 && $val->flag_pengajuan == 0 && $ceker->ya_tidak_cctv_cek == 2 && $ceker->ya_tidak_cctv_cek != NULL){ ?>
                ...
                <?php } elseif($kegi->total <= 6 && $val->flag_format_baru == 1){echo '-';}}} ?>
              </div></td>
						</tr>
					<?php 
					$no++;

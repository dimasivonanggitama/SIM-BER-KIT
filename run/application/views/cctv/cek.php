  ...
  <div class="row">
   ...
   <div class="box-header">
        ...
        <div class="box-body">
         ...
         <h4 align="center">--# LAPORAN KEGIATAN HARIAN DAPAT ANDA REKAM SETELAH MELAKUKAN CHECK LIST SECARA KESELURUHAN #--<br><br>LAPORAN MONITORING CCTV<br>BULAN <?php echo strtoupper(bulan($cctv->bulan_cctv));?> <?php echo $cctv->tahun_cctv?></h4>

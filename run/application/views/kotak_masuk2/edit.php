      ...
      <div class="col-md-6">
        ...
        <div class="col-sm-8">
          ...
          <a class="btn btn-xs btn-info" target="_blank" href="<?php echo base_url('uploads/'.$content->file_surat);?>"><i class="fa fa-eye"></i> <?php echo $lang_view;?></a>
              ...
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-4 control-label"><?php echo $lang_catatankasi;?></label>
                <div class="col-sm-8">
                  <input type="text" name="catatan" class="form-control" id="inputEmail3" placeholder="<?php echo $lang_catatankasi;?>" value="<?php echo $content->catatan_kep?>" required>
                </div>
              </div>
              <div class="form-group">
                <label for="inputEmail4" class="col-sm-4 control-label"><?php echo $lang_disposisi?></label>
                <div class="col-sm-8">
                  <select class="form-control" name="id_kasi" required>
                    <option value="0"><?php echo $lang_without_parent;?></option>
                    <?php foreach ($kasi as $val):?>
                    <option value="<?php echo $val->id_kep?> "<?php echo $val->id_kep==$content->id_kep?'selected':'';?>><?php echo $val->nama_kep?></option>
                    <?php endforeach;?>
                  </select>
                </div>
              </div>

<?php
$nama_file = "Log_book_".$user_info->name_admin.'_'.bulan($content->bulan_log_book).'_'.$content->tahun_log_book.".doc";
...
?>
  ...
  <div align="center">
    <h4>BUKU CATATAN (LOGBOOK)<br>CAPAIAN KINERJA PEGAWAI TAHUN  <?php echo $content->tahun_log_book;?></h4></div>

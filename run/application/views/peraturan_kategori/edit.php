            ...
            <?php echo form_open('','class="form-horizontal"');?>
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label"><?php echo $lang_name;?></label>

                  <div class="col-sm-10">
                    <input type="text" name="nama" class="form-control" id="inputEmail3" placeholder="<?php echo $lang_name;?>" value="<?php echo $content->nama_peraturan_kategori;?>" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="parent" required>
                    	...
                    	<?php if ($content->id_peraturan_kategori!=$val->id_peraturan_kategori){?>
                    	<option <?php echo $val->id_peraturan_kategori==$content->parent_peraturan_kategori?'selected':'';?> value="<?php echo $val->id_peraturan_kategori;?>"><?php echo $val->nama_peraturan_kategori;?></option>
                    	<?php }?>
                    	<?php endforeach;?>
                    </select>
                  </div>

							...
							<ul class="nav justify-content-end">
								...
								<li class="dropdown">
									...
									<div class="additional-dropdown-popover-menu-profile dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
										<a class="dropdown-item mdi mdi-account-key" href="<?php echo site_url('admin_Konten/getProfile'); ?>"> Profile</a>
										<a class="dropdown-item mdi mdi-settings" href="#"> Settings</a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item mdi mdi-power text-danger" href="<?php echo site_url('logout'); ?>">
											<b> Logout</b>
										</a>
									</div>
								</li>								
							...
							<div class="col-12 col-sm-8 text-center text-sm-left mb-0">
								...
								<?php if ($this->session->userdata('filterOption_data') != NULL) { ?>
									<span class="form-text page-subtitle">
										...
										pada kolom
											<?php if ($this->session->userdata['filterOption_data']['filteredBy'] == "kabupatenkota") { ?>
												<b><mark class="bg-success text-white">Kabupaten/Kota</mark></b>
											<?php } else if ($this->session->userdata['filterOption_data']['filteredBy'] == "nama_konsumen") { ?>
												<b><mark class="bg-success text-white">Nama Konsumen</mark></b>
											<?php } else if ($this->session->userdata['filterOption_data']['filteredBy'] == "alamat") { ?>
												<b><mark class="bg-success text-white">Alamat</mark></b>
											<?php } ?>
										.</p>
									</span>
								<?php } ?>
								<?php if ($this->session->userdata('sortOption_data') != NULL) { ?>
									<span class="form-text page-subtitle">
										...
										<p class="mdi mdi-sort"> Diurutkan berdasarkan 
											<?php if ($this->session->userdata['sortOption_data']['sortedBy'] == "kabupatenkota") { ?>
												<b><mark class="bg-success text-white">Kabupaten/Kota</mark></b>
											<?php } else if ($this->session->userdata['sortOption_data']['sortedBy'] == "nama_konsumen") { ?>
												<b><mark class="bg-success text-white">Nama Konsumen</mark></b>
											<?php } else if ($this->session->userdata['sortOption_data']['sortedBy'] == "alamat") { ?>
												<b><mark class="bg-success text-white">Alamat</mark></b>
											<?php } ?>
										dengan urutan 
						...
						<div class="accordion" id="accordionMiniForm">
							...
							<div class="card">
								...
								<div id="collapseOne" class="collapse <?php if ($this->session->userdata('filterOption_data') != NULL) { ?> show <?php } ?>" aria-labelledby="headingOne" data-parent="#accordionMiniForm">
									<div class="card-body">
										<form action="<?php echo base_url('dataKonsumen_filter'); ?>" method="post">
											<div class="row">
												<div class="col">
												...
												<div class="col">
													<div class="form-group">
														<select class="form-control" name="select_filter_option" required>
															<?php if ($this->session->userdata['filterOption_data']['filteredBy'] == "kabupatenkota") { ?>
																<option class="bg-success text-white" value="kabupatenkota">Kabupaten/Kota</option>
																<option value="nama_konsumen">Nama Konsumen</option>
																<option value="alamat">Alamat</option>
															<?php } else if ($this->session->userdata['filterOption_data']['filteredBy'] == "nama_konsumen") { ?>
																<option class="bg-success text-white" value="nama_konsumen">Nama Konsumen</option>
																<option value="kabupatenkota">Kabupaten/Kota</option>
																<option value="alamat">Alamat</option>
															<?php } else if ($this->session->userdata['filterOption_data']['filteredBy'] == "alamat") { ?>
																<option class="bg-success text-white" value="alamat">Alamat</option>
																<option value="kabupatenkota">Kabupaten/Kota</option>
																<option value="nama_konsumen">Nama Konsumen</option>
															<?php } else { ?>
												...
												<div class="col">
													...
													<?php if ($this->session->userdata('filterOption_data') != NULL) { ?>
														<a class="btn btn-danger" href="<?php echo base_url('dataKonsumen_filter_reset'); ?>">Reset</a>
													<?php } ?>
												</div>
											</div>
											<div class="row">
							...
							<div class="card">
								<div id="collapseTwo" class="collapse <?php if ($this->session->userdata('sortOption_data') != NULL) { ?> show <?php } ?>" aria-labelledby="headingTwo" data-parent="#accordionMiniForm">
									<div class="card-body">
										<form action="<?php echo base_url('dataKonsumen_sort'); ?>" method="post">
											<div class="row">
												<div class="col">
													<div class="form-group">
												...
												<div class="col">
													<button type="submit" class="btn btn-primary">Submit</button>
													<?php if ($this->session->userdata('sortOption_data') != NULL) { ?>
														<a class="btn btn-danger" href="<?php echo base_url('dataKonsumen_sort_reset'); ?>">Reset</a>
													<?php } ?>
												</div>
											</div>
										</form>
							...
							<div class="row">
								<table class="table">
									...
									<tbody>
										...
										<?php } else { ?>
											<?php $id_konsumen = $this->uri->segment('3') + 1; ?>
											<?php foreach ($dataKonsumen->result() as $row): ?>
												<tr class="border-bottom additional-selected-row" id="<?php echo $row->id_konsumen; ?>">
													<th scope="row"><?php echo $row->id_konsumen; ?></th>
													<td 
														<?php if ($this->session->userdata('filterOption_data') != NULL) { ?>
															<?php if ($this->session->userdata['filterOption_data']['filteredBy'] == "nama_konsumen") { ?> 
																class="additional-selected-filter" 
															<?php } ?>
														<?php } ?>
														<?php if ($this->session->userdata('sortOption_data') != NULL) { ?>
															<?php if ($this->session->userdata['sortOption_data']['sortedBy'] == "nama_konsumen") { ?> 
													...
													<td 
														...
														<?php } ?> 
													>
														<?php echo $row->kabupatenkota; ?>
													</td>
													<td 
														<?php if ($this->session->userdata('filterOption_data') != NULL) { ?>
															<?php if ($this->session->userdata['filterOption_data']['filteredBy'] == "alamat") { ?> 
																class="additional-selected-filter" 
															<?php } ?>
														<?php } ?>
														<?php if ($this->session->userdata('sortOption_data') != NULL) { ?>
															<?php if ($this->session->userdata['sortOption_data']['sortedBy'] == "alamat") { ?> 
																class="additional-selected-sort" 
															<?php } ?>
														<?php } ?>
													>
													...
													<td>
														<a data-toggle="modal" data-target="#modal_dataKonsumen-edit-row-<?php echo $row->id_konsumen; ?>" href="#"> 
															<div class="additional-table-edit-button" data-toggle="tooltip" data-placement="bottom" title="Edit">
															</div>
														</a>
														
														<!-- Modal for Edit dataKonsumen -->
														<div class="modal fade" id="modal_dataKonsumen-edit-row-<?php echo $row->id_konsumen; ?>" tabindex="-1" role="dialog" aria-labelledby="modalCenterTitle" aria-hidden="true">
																...
																<div class="modal-content">
																	...
																	<form action="<?php echo base_url('dataKonsumen_update'); ?>" method="post">
																		<div class="modal-body">
																			<input type="hidden" name="hidden_input_id" value="<?php echo $row->id_konsumen; ?>">
																			<div class="form-group">
																				<label for="input_edit_konsumen">Nama Konsumen<b class="text-danger">*</b></label>
																				<input class="form-control" id="input_edit_konsumen" name="input_konsumen" type="text" value="<?php echo $row->nama_konsumen; ?>" required>
																			</div>
																			<div class="form-group">
																				<label for="input_edit_kabupatenkota">Kabupaten/Kota<b class="text-danger">*</b></label>
																				<input class="form-control" id="input_edit_kabupatenkota" name="input_kabupatenkota" type="text" value="<?php echo $row->kabupatenkota; ?>" required>
																			</div>
																			<div class="form-group">
																				<label for="textarea_edit_alamat">Alamat<b class="text-danger">*</b></label>
																				<textarea class="form-control" id="textarea_edit_alamat" name="textarea_alamat" rows="3" required><?php echo $row->alamat; ?></textarea>
																			</div>
													...
													<td>
														<a data-toggle="modal" data-target="#modal_dataKonsumen-delete-row-<?php echo $row->id_konsumen; ?>" href="#"> 
															<div class="additional-table-delete-button" data-toggle="tooltip" data-placement="bottom" title="Hapus">
															</div>
														</a>
														
														<!-- Modal for Delete dataKonsumen per row -->
														<div aria-labelledby="modalLabel" aria-hidden="true" class="modal fade" id="modal_dataKonsumen-delete-row-<?php echo $row->id_konsumen; ?>" role="dialog" tabindex="-1">
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	<form action="<?php echo base_url('dataKonsumen_delete'); ?>" method="post">
																		...
																		<div class="modal-body">
																			<input type="hidden" name="input_hidden_id" value="<?php echo $row->id_konsumen; ?>">
																			<p>Apakah anda yakin ingin menghapus Data Konsumen dengan ID="<b class="text-danger"><?php echo $row->id_konsumen; ?></b>"?</p>
																		</div>
																		<div class="modal-footer">
																			<button type="button" class="btn btn-danger" data-dismiss="modal">Batalkan</button>
							...
							<div class="card container" id="tambahKonsumen">
								<div class="row">
									<div class="card-body">
										...
										<form action="<?php echo base_url('permintaan_add'); ?>" method="post">
											<div class="form-group">
												<label for="input_add_konsumen">Nama Konsumen<b class="text-danger">*</b></label>
												<input class="form-control" id="input_add_konsumen" name="input_konsumen" placeholder="Masukkan nama konsumen" type="text">
											</div>
											<div class="form-group">
												<label for="input_add_kabupatenkota">Kabupaten/Kota<b class="text-danger">*</b></label>
												<input class="form-control" id="input_add_kabupatenkota" name="input_kabupatenkota" placeholder="Masukkan kabupaten/kota konsumen" type="text">
											</div>
											<div class="form-group">
												<label for="input_add_alamat">Alamat<b class="text-danger">*</b></label>
												<textarea class="form-control" id="input_add_alamat" name="input_alamat" placeholder="Masukkan alamat konsumen" rows="3" required></textarea>
											</div>
											<small class="form-text text-left text-muted">(<b class="text-danger">*</b>) Diharuskan untuk mengisi bagian formulir.</small>
											<br>
							...
							<div class="card container" id="tambahKonsumen">
								<div class="row">
									<div class="card-body text-center">
										<a class="mdi mdi-content-save-all text-primary" data-toggle="modal" data-target="#modal_dataKonsumen-delete-row"> Cadangkan (Backup)</a>
										
										<a>&thinsp; &bull; &thinsp; </a>
										<a class="mdi mdi-close-circle text-danger" data-toggle="modal" data-target="#modal_dataKonsumen-delete-all"> Hapus seluruh Data Konsumen</a>
										
										<!-- Modal for Delete all dataKonsumen per row -->
										<div aria-labelledby="modalLabel" aria-hidden="true" class="modal fade" id="modal_dataKonsumen-delete-all" role="dialog" tabindex="-1">
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													<form action="<?php echo base_url('dataKonsumen_delete_all'); ?>" method="post">
														<div class="modal-header">
															<h5 class="mdi mdi-alert modal-title" id="modalLabel"> Hapus Seluruh Data Konsumen</h5>
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true" class="text-danger">&times;</span>
															</button>
														</div>
														<div class="modal-body text-left">
															<p>Apakah anda yakin ingin menghapus seluruh Data Konsumen?</p>
										...
										<a>&thinsp; &bull; &thinsp; </a>
										<a class="mdi mdi-upload text-success" data-toggle="modal" data-target="#modal_dataKonsumen-delete-row"> Unggah (upload) data</a>
									</div>
								</div>
							</div>
						</div>

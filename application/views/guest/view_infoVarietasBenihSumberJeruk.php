																...
																<div class="modal-dialog modal-dialog-centered" role="document">
																	<div class="modal-content">
																		...
																		<div class="modal-body">
																			<?php $currentDataNamaVarietasBenihSumberJeruk = $dataNamaVarietasBenihSumberJeruk[$row->$valueKolom_i - 1] ?>
																			<?php echo '<p align="center"><b><u>'.$currentDataNamaVarietasBenihSumberJeruk.'</u></b></p>'; ?>
																			<ol>
																			<?php for ($j = 0; $j < count($dataDistribusi_dataPelanggan[$currentDataNamaVarietasBenihSumberJeruk]); $j++) { ?>
																				<?php //echo count($dataDistribusi_varietas).'<br>'; ?>
																				<?php ?>
																				<li><?php echo $dataDistribusi_dataPelanggan[$currentDataNamaVarietasBenihSumberJeruk][$j]; //Karena '$row->$valueKolom_i' (ID di database) dimulai dari nomor 1, sedangkan indeks array dimulai dari nomor 0, maka untuk mengambil nilai yang diinginkan, indeks array-nya berupa '$row->$valueKolom_i - 1'. ?></li>
																			<?php } ?>
																			</ol>
